    ...
    <>
      <Section className="pt-[7.5rem] sm:pt-[9rem]">
        <Container>
          <SectionHeading
            eyebrow="গান Music"
            title="A room you build yourself"
            bangla="শব্দের মণ্ডপ"
            lede="Twelve recordings, each on its own fader. Put the dhak under the rain, move the whole thing from a Kolkata street to a riverbank with one slider, and leave it running while you work. Nothing plays until you press the disc."
          />
        </Container>
      </Section>
